...
function Player:new(world, x, y) -- constructor
    ...
    local grid = anim8.newGrid(12, 18, image:getWidth(), image:getHeight())
    local animations = {
        down = anim8.newAnimation(grid('1-4', 1), 0.1),
        left = anim8.newAnimation(grid('1-4', 2), 0.1),
        right = anim8.newAnimation(grid('1-4', 3), 0.1),
        up = anim8.newAnimation(grid('1-4', 4), 0.1)
    }
